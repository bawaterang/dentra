...
@section('title', 'Data Obat - ' . ($instansi->nama_instansi ?? 'SIGI Dental'))
...
@section('content')
    <div class="text-center mb-4">
        <h2 style="margin:0; color: #405189;">LAPORAN DATA OBAT</h2>
        <p style="margin:5px 0; color: #666; font-size: 9pt;">Daftar Inventori Obat-obatan Klinis</p>
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="font-bold">{{ $item->kode_obat }}</td>

...
<html>
<head>
    <title>Data Diagnosis - SIGI Dental EMR</title>
...
<body>
    <div class="header">
        ...
        <p>Laporan Data Diagnosis</p>
        <p>Dicetak pada: {{ date('d F Y H:i') }}</p>
    </div>
    <table>
        <thead><tr><th width="5%">No</th><th>Kode ICD-10</th><th>Nama Diagnosa</th><th>Kategori</th><th>Status</th></tr></thead>
        <tbody>

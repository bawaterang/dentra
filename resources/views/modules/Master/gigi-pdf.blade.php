...
<html>
<head>
    <title>Data Kategori Gigi - SIGI Dental EMR</title>
...
<body>
    <div class="header">
        ...
        <p>Laporan Data Kategori Gigi</p>
        <p>Dicetak pada: {{ date('d F Y H:i') }}</p>
    </div>
    <table>
        <thead><tr><th width="5%">No</th><th>Kode</th><th>Nama Kategori</th><th>Warna</th><th>Status</th></tr></thead>
        <tbody>

...
<html>
<head>
    <title>Data Asuransi - SIGI Dental EMR</title>
...
<body>
    <div class="header">
        ...
        <p>Laporan Data Asuransi</p>
        <p>Dicetak pada: {{ date('d F Y H:i') }}</p>
    </div>
    <table>
        <thead><tr><th width="5%">No</th><th>Kode</th><th>Nama Asuransi</th><th>Tipe</th><th>Diskon</th><th>No. Telepon</th><th>Status</th></tr></thead>
        <tbody>

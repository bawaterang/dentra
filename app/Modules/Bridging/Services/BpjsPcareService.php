...
class BpjsPcareService
{
    ...
    /**
     * Get all endpoint definitions (shared between Documentation and Monitoring)
     */
    public static function getEndpointRegistry(): array
    {
        return [
            // === REFERENSI ===
            'dokter' => [
            ...
            'statuspulang' => [
                ...
                'color' => '#299cdb',
                'method' => 'GET',
                'endpoint' => '/statuspulang/rawatInap/{isRawatInap}',
                'params' => ['isRawatInap'],
            ...
            'obat' => [
                ...
                'color' => '#0d6efd',
                'method' => 'GET',
                'endpoint' => '/obat/dpho/{keyword}/{start}/{limit}',
                'params' => ['keyword', 'start', 'limit'],
            ...
            'antrean_poli' => [
                ...
                'params' => ['tanggal'],
                'response_fields' => ['nmpoli' => 'Nama Poli', 'nmsubspesialis' => 'Nama Sub Spesialis'],
            ],
            // === PESERTA ===
            'peserta_no_kartu' => [
            ...
            'riwayat_kunjungan' => [
                ...
                'color' => '#299cdb',
                'method' => 'GET',
                'endpoint' => '/kunjungan/peserta/{noKartu}',
                'params' => ['noKartu'],
            ],
            // === RUJUKAN ===
            'rujukan' => [
                ...
                'color' => '#f672a7',
                'method' => 'GET',
                'endpoint' => '/kunjungan/rujukan/{noKunjungan}',
                'params' => ['noKunjungan'],
            ],
            // === SKRINNING ===
            'skrinning_peserta' => [
                ...
                'color' => '#4b38b3',
                'method' => 'GET',
                'endpoint' => '/skrinning/peserta/{noKartuOrNama}/{start}/{limit}',
                'params' => ['keyword', 'start', 'limit'],
            ],
            'antrean_dokter' => [
            ...
            'tindakan_kunjungan' => [
                ...
                'category' => 'Tindakan',
                'method' => 'GET',
                'endpoint' => '/tindakan/kunjungan/{noKunjungan}',
                'params' => ['noKunjungan'],
            ],
            'prolanis_dm' => [
                'label' => 'Prolanis DM',
                'category' => 'Skrinning',
                'method' => 'GET',
                'endpoint' => '/skrinning/prolanis/dm/{noKartuOrNama}/{start}/{limit}',
                'params' => ['keyword', 'start', 'limit'],
            ],
            'prolanis_ht' => [
                'label' => 'Prolanis HT',
                'category' => 'Skrinning',
                'method' => 'GET',
                'endpoint' => '/skrinning/prolanis/ht/{noKartuOrNama}/{start}/{limit}',
                'params' => ['keyword', 'start', 'limit'],
            ],
            'mcu' => [
                'label' => 'Data MCU',

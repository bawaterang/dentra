...
Route::middleware(['web', 'auth'])->prefix('pendaftaran')->name('pendaftaran.')->group(function () {
    Route::get('/', PendaftaranPage::class)->name('index');
    Route::get('/create', FormPendaftaranPage::class)->name('create');
    Route::get('/print/{id}', [\App\Modules\Pendaftaran\Http\Controllers\PendaftaranPrintController::class, 'print'])->name('print');
});

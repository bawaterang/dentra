...
{
    public $items = [['G001', '11', 'Kanan Atas', 'Normal'], ['G002', '18', 'Kanan Atas (Molar 3)', 'Impacted'], ['G003', '46', 'Kanan Bawah', 'Karies']];
    ...
    public function render()
    {
        ...
        ">
            ...
            <div class="mb-4 flex flex-col md:flex-row md:items-center justify-between gap-4 px-2">
                <div>
                    <h4 class="mb-1 text-lg font-bold text-[#495057] uppercase tracking-wider">Gigi</h4>
                    <nav class="flex text-sm text-[#878a99]" aria-label="Breadcrumb">
                        <ol class="inline-flex list-none items-center p-0">
                            ...
                            <li class="text-[#495057] font-semibold">Data Gigi</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="mb-4 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <div class="card">
                    <div class="flex items-center p-6 gap-4">
                        <div class="flex h-12 w-12 items-center justify-center rounded-lg bg-info-subtle text-info">
                            <i class="ri-tooth-line text-xl"></i>
                        </div>
                        <div>
                            <p class="mb-1 text-[#878a99] font-medium text-sm">Total Gigi</p>
                            <h4 class="mb-0 font-bold text-xl text-[#495057]">32</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="flex items-center p-6 gap-4">
                        ...
                        <div>
                            <p class="mb-1 text-[#878a99] font-medium text-sm">Permanen</p>
                            <h4 class="mb-0 font-bold text-xl text-[#495057]">32</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="flex items-center p-6 gap-4">
                        <div class="flex h-12 w-12 items-center justify-center rounded-lg bg-warning-subtle text-warning">
                            <i class="ri-baby-line text-xl"></i>
                        </div>
                        <div>
                            <p class="mb-1 text-[#878a99] font-medium text-sm">Susu</p>
                            <h4 class="mb-0 font-bold text-xl text-[#495057]">0</h4>
                        </div>
                    </div>
                </div>
            ...
            <div class="mb-3 flex flex-col sm:flex-row justify-end">
                <button class="btn btn-primary w-full sm:w-auto h-10 sm:h-9 px-4 sm:px-6 shadow-sm flex items-center justify-center sm:justify-start gap-2 transition-all hover:translate-y-[-2px]">
                    ...
                    <span class="font-semibold text-sm sm:text-sm">Tambah Gigi</span>
                </button>
            </div>

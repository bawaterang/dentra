                        ...
                        <form wire:submit.prevent="save">
                            <div class="space-y-4">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div><label class="block text-xs font-semibold text-gray-500 mb-1">Icon (Remixicon)</label><input type="text" wire:model="menu_icon" class="w-full rounded-lg border-gray-200 text-sm px-4 py-2.5 focus:border-[#405189] transition-all" placeholder="ri-dashboard-line"></div>
                                </div>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div><label class="block text-xs font-semibold text-gray-500 mb-1">Parent ID</label><input type="number" wire:model="parent_id" class="w-full rounded-lg border-gray-200 text-sm px-4 py-2.5 focus:border-[#405189] transition-all" placeholder="Kosongkan jika root"></div>

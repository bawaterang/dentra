...
{
    public $items = [['M001', 'Dashboard', '-', 'Aktif'], ['M002', 'Data Pasien', 'Master', 'Aktif'], ['M003', 'Data Dokter', 'Master', 'Aktif']];
    ...
    public function render()
    {
        ...
        ">
            ...
            <div class="mb-4 flex flex-col md:flex-row md:items-center justify-between gap-4 px-2">
                <div>
                    <h4 class="mb-1 text-lg font-bold text-[#495057] uppercase tracking-wider">Menu</h4>
                    <nav class="flex text-sm text-[#878a99]" aria-label="Breadcrumb">
                        <ol class="inline-flex list-none items-center p-0">
                            ...
                            <li class="text-[#495057] font-semibold">Data Menu</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="mb-4 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <div class="card">
                    <div class="flex items-center p-6 gap-4">
                        <div class="flex h-12 w-12 items-center justify-center rounded-lg bg-info-subtle text-info">
                            <i class="ri-menu-search-line text-xl"></i>
                        </div>
                        <div>
                            <p class="mb-1 text-[#878a99] font-medium text-sm">Total Menu</p>
                            <h4 class="mb-0 font-bold text-xl text-[#495057]">45</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="flex items-center p-6 gap-4">
                        ...
                        <div>
                            <p class="mb-1 text-[#878a99] font-medium text-sm">Sub Menu</p>
                            <h4 class="mb-0 font-bold text-xl text-[#495057]">38</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="flex items-center p-6 gap-4">
                        ...
                        <div>
                            <p class="mb-1 text-[#878a99] font-medium text-sm">Aktif</p>
                            <h4 class="mb-0 font-bold text-xl text-[#495057]">45</h4>
                        </div>
                    </div>
                </div>
            ...
            <div class="mb-3 flex flex-col sm:flex-row justify-end">
                <button class="btn btn-primary w-full sm:w-auto h-10 sm:h-9 px-4 sm:px-6 shadow-sm flex items-center justify-center sm:justify-start gap-2 transition-all hover:translate-y-[-2px]">
                    ...
                    <span class="font-semibold text-sm sm:text-sm">Tambah Menu</span>
                </button>
            </div>
